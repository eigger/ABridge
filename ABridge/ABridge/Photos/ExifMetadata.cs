...
namespace PhotoViewerDemo
{
    public class ExifMetadata
    {
        ...
        public string[] tags
        {
            get
            {
                return (string[])QueryMetadata("System.Keywords");
            }
            set
            {
                QueryMetadata("System.Keywords", value);
            }
        ...
        private object QueryMetadata(string query, object value = null)
        {
            if (value == null)
            {
            ...
            {
                if (_metadata.ContainsQuery(query))
                    _metadata.SetQuery(query, value);
            }
            return null;
        }
    }
